...
BOOST_AUTO_TEST_CASE(universe_step__test) {
  NB::Universe universe("planets.txt");
  double x = 1.4960e+11;
  double y = 1.19750003e+09;

  universe.step(25000);

  BOOST_CHECK_CLOSE(universe[0].position().x, x, 0.1);
  BOOST_CHECK_CLOSE(universe[2].position().y, y, 0.1);
}
